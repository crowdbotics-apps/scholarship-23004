"""scholarship_23004 URL Configuration
...
admin.site.site_header = "scholarship"
admin.site.site_title = "scholarship Admin Portal"
admin.site.index_title = "scholarship Admin"

# swagger
api_info = openapi.Info(
    title="scholarship API",
    default_version="v1",
    description="API documentation for scholarship App",
)
